 ...
 *
 * Protoypes and definitions for ARINC429 protocol modules using the PF_ARINC429 core
 *
...
#define ARINC429_VERSION "20150901"

/* increment this number each time you change some user-space interface */
#define ARINC429_ABI_VERSION "1"

#define ARINC429_VERSION_STRING "rev " ARINC429_VERSION " abi " ARINC429_ABI_VERSION

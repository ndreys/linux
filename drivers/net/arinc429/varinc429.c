 ...
 * See Documentation/networking/arinc429.txt for details.
 */

static bool echo = 1; /* echo testing. Default: 0 (Off) */
...
static __init int varinc429_init_module(void)
{
	...
	if (echo)
		printk(KERN_INFO "varinc429: enabled echo on driver level.\n");

...
#define SMI_CMD_OP_45_WRITE		((0 << 10) | SMI_CMD_BUSY)
...
#define PORT_STATUS_EEE		BIT(7)
#define PORT_STATUS_MGMII	BIT(6)
#define PORT_STATUS_TX_PAUSED	BIT(5)
#define PORT_STATUS_FLOW_CTRL	BIT(4)
#define PORT_STATUS_C_DUPLEX	BIT(3)
...
#define GLOBAL_CONTROL_SCHED_PRIO	BIT(11)
#define GLOBAL_CONTROL_MAX_FRAME_1632	BIT(10)
#define GLOBAL_CONTROL_RELOAD_EEPROM	BIT(9)
#define GLOBAL_CONTROL_STATS_DONE	BIT(6)
#define GLOBAL_CONTROL_VTU_PROBLEM	BIT(5)
#define GLOBAL_CONTROL_VTU_DONE		BIT(4)
#define GLOBAL_CONTROL_ATU_PROBLEM	BIT(3)
#define GLOBAL_CONTROL_ATU_DONE		BIT(2)
#define GLOBAL_CONTROL_EEPROM_DONE	BIT(1)
...
#define GLOBAL2_SMI_OP_22_READ		((2 << 10) | GLOBAL2_SMI_OP_BUSY | \
					 GLOBAL2_SMI_OP_CLAUSE_22)
#define GLOBAL2_SMI_OP_45_WRITE		((0 << 10) | GLOBAL2_SMI_OP_BUSY)

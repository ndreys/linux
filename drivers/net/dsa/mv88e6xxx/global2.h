...
#define MV88E6XXX_G2_IMP_DEBUG			0x13
#define MV88E6XXX_G2_IMP_DEBUG_UPDATE		BIT(15)
#define MV88E6XXX_G2_IMP_DEBUG_POINTER		GENMASK(14, 8)
#define MV88E6XXX_G2_IMP_DEBUG_DATA		GENMASK(7, 0)

...
enum mv88e6xxx_cap {
	 ...
	 * The device contains a set of 16-bit registers for each port.
	 */
	MV88E6XXX_CAP_PORT_FORCE,	/* (0x01) Physical control */
	MV88E6XXX_CAP_PORT_FORCE_SPEED,	/* (0x01) Physical control */
	MV88E6XXX_CAP_PORT_SPEED_ALT,	/* (0x01) Physical control */
	MV88E6XXX_CAP_PORT_JUMBO,	/* (0x08) Control 2 */

	/* Switch Global 1 Registers.
	 * The device contains a set of global 16-bit registers.
	 */
	MV88E6XXX_CAP_G1_FID,		/* (0x02) VTU FID */
	...
	/* Statistics Unit. The statistics can be spread over two banks in
	 * a dedicated set of stats registers and/or in port registers.
	 */
	MV88E6XXX_CAP_STATS_BANK1_9,	/* Bit 9 in the register */
	MV88E6XXX_CAP_STATS_BANK1_10,	/* Bit 10 in the register */
...
#define MV88E6XXX_FLAG_PORT_FORCE	BIT_ULL(MV88E6XXX_CAP_PORT_FORCE)
#define MV88E6XXX_FLAG_PORT_FORCE_SPEED	BIT_ULL(MV88E6XXX_CAP_PORT_FORCE_SPEED)
#define MV88E6XXX_FLAG_PORT_JUMBO	BIT_ULL(MV88E6XXX_CAP_PORT_JUMBO)
#define MV88E6XXX_FLAG_PORT_SPEED_ALT	BIT_ULL(MV88E6XXX_CAP_PORT_SPEED_ALT)
#define MV88E6XXX_FLAG_G1_FID		BIT_ULL(MV88E6XXX_CAP_G1_FID)
...
#define MV88E6XXX_FLAG_STATS_BANK1_9	BIT_ULL(MV88E6XXX_CAP_STATS_BANK1_9)
#define MV88E6XXX_FLAG_STATS_BANK1_10	BIT_ULL(MV88E6XXX_CAP_STATS_BANK1_10)
#define MV88E6XXX_FLAG_STATS_HISTOGRAM	BIT_ULL(MV88E6XXX_CAP_STATS_HISTOGRAM)
#define MV88E6XXX_FLAG_STATS_PORT	BIT_ULL(MV88E6XXX_CAP_STATS_PORT)
#define MV88E6XXX_FLAG_STATS_SHIFT	BIT_ULL(MV88E6XXX_CAP_STATS_SHIFT)

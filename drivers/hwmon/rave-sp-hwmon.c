...
static int rave_sp_hwmon_spu3_read_string(struct device *dev,
					  enum hwmon_sensor_types type,
					  u32 attr, int channel,
					  const char **str)
{
...
static const struct hwmon_channel_info *spu3_info[] = {
	HWMON_CHANNEL_INFO(in,    HWMON_I_INPUT | HWMON_I_LABEL,
				  HWMON_I_INPUT | HWMON_I_LABEL,
				  HWMON_I_INPUT | HWMON_I_LABEL,
				  HWMON_I_INPUT | HWMON_I_LABEL,
...
static struct hwmon_ops spu3_ops = {
	.is_visible	= rave_sp_hwmon_rdu_is_visible,
	.read		= rave_sp_hwmon_rdu2_read,
	.read_string	= rave_sp_hwmon_spu3_read_string,
};
...
static const struct hwmon_chip_info spu3_hwmon = {
	.ops	= &spu3_ops,
	.info	= spu3_info,
};
...
static const struct of_device_id rave_sp_hwmon_of_match[] = {
	...
	{
		.compatible = "zii,rave-sp-hwmon-spu3",
		.data = &spu3_hwmon,
	},
	{ /* sentinel */ }
};

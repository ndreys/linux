...
static u8 rdu2_fallback_edid[] = {
	
};
static struct edid *rdu2_bad_edid_workaround(struct device *dev)
{
	struct edid *edid;

	if (!of_machine_is_compatible("zii,imx6qp-zii-rdu2") &&
	    !of_machine_is_compatible("zii,imx6q-zii-rdu2"))
		return NULL;

	dev_warn(dev, "Using builtin fallback EDID data!\n");

	edid = kmalloc(sizeof(rdu2_fallback_edid), GFP_KERNEL);
	if (!edid)
		return NULL;

	memcpy(edid, rdu2_fallback_edid, sizeof(rdu2_fallback_edid));
...
static int tc_connector_get_modes(struct drm_connector *connector)
{
	...
	if (!edid)
		edid = rdu2_bad_edid_workaround(tc->dev);
